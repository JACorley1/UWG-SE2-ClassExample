...
class TestGetCategories {
	...
	@Test
	void testMultipleCategoriesOneRecipe() {
	...
	@Test
	void testMultipleCategoriesMultipleRecipes() {
		ArrayList<Recipe> recipes = new ArrayList<Recipe>();
		
		Recipe recipe1 = new Recipe("lasagna", List.of("pasta", "italian"), 1.0, 2.0, List.of("meat", "noodles", "sauce", "cheese"), List.of("Combine ingredients", "Cook ingredients"), 2);
		recipes.add(recipe1);
		
		Recipe recipe2 = new Recipe("eggplant parmesan", List.of("vegetarian"), 3.0, 4.0, List.of("eggplant", "noodles", "sauce", "cheese"), List.of("Combine ingredients", "Cook ingredients"), 4);
		recipes.add(recipe2);
	...
	@Test
	void testDuplicateCategoriesMultipleRecipes() {
		ArrayList<Recipe> recipes = new ArrayList<Recipe>();
